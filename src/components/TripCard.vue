...
const photos = computed(() => (props.trip.photos?.length ? props.trip.photos : [fallbackPhoto]));
...
.tag-chip {
    ...
    background: linear-gradient(120deg, rgba(59, 130, 246, 0.55), rgba(14, 165, 233, 0.4));
